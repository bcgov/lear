...
class DCCredential(db.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def json(self):
        ...
        dc_credential = {
            ...
            'dateOfRevocation': self.date_of_revocation.isoformat() if self.date_of_revocation else None,
            'credentialRevocationId': self.credential_revocation_id,
            'revocationRegistryId': self.revocation_registry_id,
            'credentialJson': self.credential_json,
            'selfAttestedRoles': self.self_attested_roles,
