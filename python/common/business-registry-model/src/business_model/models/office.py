...
class Office(db.Model, Versioned):  # pylint: disable=too-few-public-methods
    ...
    # business_id = db.Column('business_id', db.Integer, db.ForeignKey('businesses.id'), index=True) # noqa: ERA001
    addresses = db.relationship('Address', backref='office', lazy='dynamic', cascade='all, delete, delete-orphan', passive_deletes=True)
