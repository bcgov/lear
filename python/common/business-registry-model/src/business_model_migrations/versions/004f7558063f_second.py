...
def upgrade():
    ...
    with op.batch_alter_table("addresses", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_addresses_address_type"), ["address_type"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_addresses_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_addresses_legal_entity_id"),
            ["legal_entity_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_addresses_street"), ["street"], unique=False
        )
    ...
    op.create_table(
        "corp_types_history",
        sa.Column(
            "corp_type_cd", sa.String(length=5), autoincrement=False, nullable=False
        ),
        sa.Column(
            "colin_ind", sa.String(length=1), autoincrement=False, nullable=False
        ),
        sa.Column(
            "corp_class", sa.String(length=10), autoincrement=False, nullable=False
        ),
        sa.Column(
            "short_desc", sa.String(length=25), autoincrement=False, nullable=False
        ),
        sa.Column(
            "full_desc", sa.String(length=100), autoincrement=False, nullable=False
        ),
        sa.Column(
            "legislation", sa.String(length=100), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "credential_type",
            sa.Enum("business", "business_relationship", name="credentialtype"),
            nullable=False,
        ),
    ...
    with op.batch_alter_table("naics_structures", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_naics_structures_class_definition"),
            ["class_definition"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_naics_structures_class_title"), ["class_title"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_structures_code"), ["code"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_structures_level"), ["level"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_structures_version"), ["version"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_structures_year"), ["year"], unique=False
        )
    ...
    with op.batch_alter_table("registration_bootstrap", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_registration_bootstrap_account"), ["account"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "username", sa.String(length=1000), autoincrement=False, nullable=True
        ),
        sa.Column(
            "firstname", sa.String(length=1000), autoincrement=False, nullable=True
        ),
        sa.Column(
            "lastname", sa.String(length=1000), autoincrement=False, nullable=True
        ),
        sa.Column(
            "middlename", sa.String(length=1000), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "idp_userid", sa.String(length=256), autoincrement=False, nullable=True
        ),
        sa.Column(
            "login_source", sa.String(length=200), autoincrement=False, nullable=True
        ),
        sa.Column(
            "creation_date",
    ...
    with op.batch_alter_table("users_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_users_history_idp_userid"), ["idp_userid"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_users_history_username"), ["username"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column(
            "address_type", sa.String(length=4096), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "postal_code", sa.String(length=15), autoincrement=False, nullable=True
        ),
        sa.Column(
    ...
    with op.batch_alter_table("addresses_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_addresses_history_address_type"),
            ["address_type"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_addresses_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_addresses_history_legal_entity_id"),
            ["legal_entity_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_addresses_history_street"), ["street"], unique=False
        )
    ...
    with op.batch_alter_table("aliases", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_aliases_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("aliases_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_aliases_history_alias"), ["alias"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_aliases_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("alternate_names", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_alternate_names_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column(
            "identifier", sa.String(length=10), autoincrement=False, nullable=True
        ),
        sa.Column(
            "name_type",
            sa.Enum("OPERATING", name="nametype"),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.Column(
            "end_date", sa.DateTime(timezone=True), autoincrement=False, nullable=True
        ),
        sa.Column("legal_entity_id", sa.Integer(), autoincrement=False, nullable=True),
        sa.Column("change_filing_id", sa.Integer(), autoincrement=False, nullable=True),
        sa.Column("naics_key", sa.String(length=50), nullable=True),
    ...
    with op.batch_alter_table("alternate_names_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_alternate_names_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("colin_entities", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_colin_entities_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_colin_entities_email"), ["email"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_colin_entities_identifier"), ["identifier"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_colin_entities_organization_name"),
            ["organization_name"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column("change_filing_id", sa.Integer(), autoincrement=False, nullable=True),
        sa.Column(
            "delivery_address_id", sa.Integer(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "mailing_address_id", sa.Integer(), autoincrement=False, nullable=True
        ),
        sa.Column("version", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column("changed", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
    ...
    with op.batch_alter_table("colin_entities_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_colin_entities_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_colin_entities_history_email"), ["email"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_colin_entities_history_identifier"),
            ["identifier"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_colin_entities_history_organization_name"),
            ["organization_name"],
            unique=False,
        )
    ...
    with op.batch_alter_table("comments", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_comments_filing_id"), ["filing_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_comments_legal_entity_id"), ["legal_entity_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_comments_staff_id"), ["staff_id"], unique=False
        )
    ...
    with op.batch_alter_table("documents", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_documents_filing_id"), ["filing_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_documents_legal_entity_id"),
            ["legal_entity_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "file_key", sa.String(length=100), autoincrement=False, nullable=False
        ),
        sa.Column("legal_entity_id", sa.Integer(), autoincrement=False, nullable=True),
    ...
    with op.batch_alter_table("documents_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_documents_history_filing_id"), ["filing_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_documents_history_legal_entity_id"),
            ["legal_entity_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "last_remote_ledger_id", sa.Integer(), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "legal_name", sa.String(length=1000), autoincrement=False, nullable=True
        ),
        sa.Column(
            "entity_type", sa.String(length=15), autoincrement=False, nullable=True
        ),
        sa.Column(
            "founding_date",
            sa.DateTime(timezone=True),
        ...
        sa.Column(
            "start_date", sa.DateTime(timezone=True), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "last_ar_reminder_year", sa.Integer(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "association_type", sa.String(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "state",
            sa.Enum("ACTIVE", "HISTORICAL", "LIQUIDATION", name="state"),
            autoincrement=False,
            nullable=True,
        ),
        ...
        sa.Column(
            "first_name", sa.String(length=30), autoincrement=False, nullable=True
        ),
        sa.Column(
            "middle_initial", sa.String(length=30), autoincrement=False, nullable=True
        ),
        sa.Column(
            "last_name", sa.String(length=30), autoincrement=False, nullable=True
        ),
        sa.Column(
            "additional_name", sa.String(length=100), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "naics_key", sa.String(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "naics_code", sa.String(length=10), autoincrement=False, nullable=True
        ),
        sa.Column(
            "naics_description",
    ...
    with op.batch_alter_table("legal_entities_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_legal_entities_history_entity_type"),
            ["entity_type"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_history_first_name"),
            ["first_name"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_history_identifier"),
            ["identifier"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_history_legal_name"),
            ["legal_name"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_history_middle_initial"),
            ["middle_initial"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_history_tax_id"), ["tax_id"], unique=False
        )
    ...
    with op.batch_alter_table("naics_elements", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_naics_elements_class_title"), ["class_title"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_elements_code"), ["code"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_elements_element_description"),
            ["element_description"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_naics_elements_element_type"), ["element_type"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_elements_level"), ["level"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_elements_naics_structure_id"),
            ["naics_structure_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_naics_elements_version"), ["version"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_naics_elements_year"), ["year"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column(
            "office_type", sa.String(length=75), autoincrement=False, nullable=True
        ),
        sa.Column(
            "deactivated_date",
            sa.DateTime(timezone=True),
    ...
    with op.batch_alter_table("offices_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_offices_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_offices_history_legal_entity_id"),
            ["legal_entity_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("parties", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_parties_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_parties_first_name"), ["first_name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_parties_middle_initial"), ["middle_initial"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column(
            "party_type", sa.String(length=30), autoincrement=False, nullable=True
        ),
        sa.Column(
            "first_name", sa.String(length=30), autoincrement=False, nullable=True
        ),
    ...
    with op.batch_alter_table("parties_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_parties_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_parties_history_first_name"), ["first_name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_parties_history_middle_initial"),
            ["middle_initial"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "service_name", sa.Enum("BN_HUB", name="servicename"), nullable=False
        ),
        sa.Column("creation_date", sa.DateTime(timezone=True), nullable=True),
        sa.Column("last_modified", sa.DateTime(timezone=True), nullable=True),
    ...
    with op.batch_alter_table("request_tracker", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_request_tracker_filing_id"), ["filing_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_request_tracker_legal_entity_id"),
            ["legal_entity_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("role_addresses", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_role_addresses_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("role_addresses_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_role_addresses_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("share_classes", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_share_classes_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_share_classes_name"), ["name"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "special_rights_flag", sa.Boolean(), autoincrement=False, nullable=True
        ),
        sa.Column("legal_entity_id", sa.Integer(), autoincrement=False, nullable=True),
        sa.Column("change_filing_id", sa.Integer(), autoincrement=False, nullable=True),
        sa.Column("version", sa.Integer(), autoincrement=False, nullable=False),
    ...
    with op.batch_alter_table("share_classes_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_share_classes_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_share_classes_history_name"), ["name"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("legal_entity_id", sa.Integer(), autoincrement=False, nullable=True),
        sa.Column(
            "related_entity_id", sa.Integer(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "related_colin_entity_id", sa.Integer(), autoincrement=False, nullable=True
        ),
        sa.Column("filing_id", sa.Integer(), autoincrement=False, nullable=True),
        sa.Column(
            "delivery_address_id", sa.Integer(), autoincrement=False, nullable=True
    ...
    with op.batch_alter_table("resolutions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_resolutions_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "signing_legal_entity_id", sa.Integer(), autoincrement=False, nullable=True
        ),
        sa.Column("version", sa.Integer(), autoincrement=False, nullable=False),
        sa.Column("changed", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
    ...
    with op.batch_alter_table("resolutions_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_resolutions_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("share_series", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_share_series_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_share_series_name"), ["name"], unique=False
        )
    ...
    with op.batch_alter_table("share_series_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_share_series_history_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_share_series_history_name"), ["name"], unique=False
        )
    ...
    with op.batch_alter_table("filings", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "payment_completion_date", sa.DateTime(timezone=True), nullable=True
            )
        )
        ...
        batch_op.add_column(
            sa.Column(
                "court_order_effect_of_order", sa.String(length=500), nullable=True
            )
        )
        batch_op.add_column(
        ...
        batch_op.create_foreign_key(
            None, "registration_bootstrap", ["temp_reg"], ["identifier"]
        )
    ...
    with op.batch_alter_table("legal_entities", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "last_ledger_timestamp", sa.DateTime(timezone=True), nullable=True
            )
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column("entity_type", sa.String(length=15), nullable=True)
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column(
                "restoration_expiry_date", sa.DateTime(timezone=True), nullable=True
            )
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column(
                "continuation_out_date", sa.DateTime(timezone=True), nullable=True
            )
        )
        batch_op.add_column(
            sa.Column("identifier", sa.String(length=10), nullable=True)
        ...
        batch_op.add_column(
            sa.Column("additional_name", sa.String(length=100), nullable=True)
        )
        ...
        batch_op.add_column(
            sa.Column(
                "foreign_jurisdiction_region", sa.String(length=10), nullable=True
            )
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column(
                "foreign_incorporation_date", sa.DateTime(timezone=True), nullable=True
            )
        )
        batch_op.add_column(sa.Column("version", sa.Integer(), nullable=False))
        batch_op.create_index(
            batch_op.f("ix_legal_entities_entity_type"), ["entity_type"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_first_name"), ["first_name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_identifier"), ["identifier"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_legal_name"), ["legal_name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_middle_initial"),
            ["middle_initial"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_legal_entities_tax_id"), ["tax_id"], unique=False
        )
    ...
    with op.batch_alter_table("offices", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("version", sa.Integer(), nullable=False))
        batch_op.create_index(
            batch_op.f("ix_offices_change_filing_id"),
            ["change_filing_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_offices_legal_entity_id"), ["legal_entity_id"], unique=False
        )
        batch_op.create_foreign_key(None, "filings", ["change_filing_id"], ["id"])
        batch_op.create_foreign_key(
            None, "office_types", ["office_type"], ["identifier"]
        )
        batch_op.create_foreign_key(None, "legal_entities", ["legal_entity_id"], ["id"])
