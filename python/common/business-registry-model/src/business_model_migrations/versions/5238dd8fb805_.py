...
amalgamation_type_enum = postgresql.ENUM("regular", "vertical", "horizontal", name="amalgamation_type")
...
def upgrade():
    ...
    with op.batch_alter_table("amalgamating_businesses", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_amalgamating_businesses_change_filing_id"), ["change_filing_id"], unique=False
        )
    ...
    with op.batch_alter_table("amalgamations_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_amalgamations_version_history_legal_entity_id"), ["legal_entity_id"], unique=False
        )
    ...
    with op.batch_alter_table("amalgamating_businesses_history", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_amalgamating_businesses_history_legal_entity_id"), ["legal_entity_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_amalgamating_businesses_history_amalgamation_id"), ["amalgamation_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_amalgamating_businesses_history_change_filing_id"), ["change_filing_id"], unique=False
        )
