...
def upgrade():
    ...
    op.add_column('businesses', sa.Column('naics_title', sa.String(length=150), nullable=True))
    ...
    op.add_column('businesses_version', sa.Column('naics_title', sa.String(length=150), nullable=True))
...
def downgrade():
    ...
    op.drop_column('businesses_version', 'naics_title')
    ...
    op.drop_column('businesses', 'naics_title')
