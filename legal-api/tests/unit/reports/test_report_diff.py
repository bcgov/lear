...
def test_format_with_diff_data(session):
    ...
    parties = [
        ...
        },
        {
            ...
            'officer': {'id': '700237d2-9f96-4e9d-9591-55de0951f565', 'email': 'abc@xyz.com', 'organizationName': '', 'lastName': 'M', 'firstName': 'MM', 'partyType': 'person', 'middleName': ''},  # noqa: E501;
