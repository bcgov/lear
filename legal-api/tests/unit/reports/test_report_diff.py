...
def test_format_with_diff_data(session):
    ...
    filing = {
        ...
        'incorporationApplication': {
            ...
            'nameTranslations': {'new': ['test_d'], 'ceased': ['TEST_B'], 'modified': [{'newValue': 'TEST_C', 'oldValue': 'TEST_A'}]},  # noqa: E501;
    ...
    offices = filing['incorporationApplication']['offices']
    ...
    parties = filing['incorporationApplication']['parties']
    ...
    share_classes = filing['incorporationApplication']['shareStructure']['shareClasses']
