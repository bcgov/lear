...
def test_get_business_aliases(session, client, jwt):
    ...
    # test
    rv = client.get(f'/api/v1/businesses/{identifier}/aliases',
...
def test_get_business_alias_by_id(session, client, jwt):
    ...
    alias2.save()
    # test
    rv = client.get(f'/api/v1/businesses/{identifier}/aliases/{alias1.id}',
                    headers=create_header(jwt, [STAFF_ROLE], identifier)
                    )
    # check
    assert rv.status_code == HTTPStatus.OK
...
def test_get_business_alias_by_invalid_id(session, client, jwt):
    ...
    # test
    rv = client.get(f'/api/v1/businesses/{identifier}/aliases/{alias_id}',
                    headers=create_header(jwt, [STAFF_ROLE], identifier)
                    )
    # check
...
def test_get_business_alias_by_invalid_type(session, client, jwt):
    ...
    # test
    rv = client.get(f'/api/v1/businesses/{identifier}/aliases?type=invalid',
                    headers=create_header(jwt, [STAFF_ROLE], identifier)
                    )
    # check
    assert rv.status_code == HTTPStatus.OK
