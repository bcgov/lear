...
def test_delete_continuation_in_filing_with_authorization_files_in_draft(session, client, jwt, minio_server):
    ...
    auth_file_content_1 = b"This is the content of the first authorization file."
    auth_file_content_2 = b"This is the content of the second authorization file."
    file_key_1 = _upload_file(auth_file_content_1, invalid=False)
    file_key_2 = _upload_file(auth_file_content_2, invalid=False)
...
def test_delete_continuation_in_filing_with_affidavit_in_draft(session, client, jwt, minio_server):
    ...
    affidavit_content = b"This is the content of the affidavit file."
    file_key = _upload_file(affidavit_content, invalid=False)
