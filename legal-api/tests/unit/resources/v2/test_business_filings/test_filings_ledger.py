...
def test_ledger_comment_count(session, client, jwt):
    ...
    legal_entity, filing_storage = ledger_element_setup_help(identifier)
...
def test_ledger_display_name_annual_report(session, client, jwt):
    ...
    legal_entity, filing_storage = ledger_element_setup_help(identifier, 'annualReport')
...
def test_ledger_display_unknown_name(session, client, jwt):
    ...
    legal_entity, filing_storage = ledger_element_setup_help(identifier, 'someAncientNamedReport')
    filing_storage._meta_data = meta_data
    filing_storage.save()
...
def test_ledger_display_alteration_report(session, client, jwt):
    ...
    legal_entity, filing_storage = ledger_element_setup_help(identifier, 'alteration')
    filing_storage._meta_data = meta_data
    filing_storage.save()
