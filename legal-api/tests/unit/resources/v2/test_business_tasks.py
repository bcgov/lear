...
@pytest.mark.parametrize('test_name, identifier, legal_type, founding_date, last_ar_date, restored_date, incomplete_filing_type, expected', [
    ...
    ('TA_2_AR_1', 'BC1234567', Business.LegalTypes.BCOMP.value, datetime(1999, 7, 2, 8), datetime(2024, 7, 2, 8), datetime(2025, 9, 1), None, [{'order': 2, 'name': 'transition', 'enabled': False}, {'order': 1, 'name': 'annualReport', 'ARFilingYear': 2025, 'enabled': True}]),
    ('TA_2_AR_1_AR_3', 'BC1234567', Business.LegalTypes.BCOMP.value, datetime(1999, 7, 2, 8), datetime(2023, 7, 2, 8), datetime(2024, 9, 1), None, [{'order': 2, 'name': 'transition', 'enabled': False}, {'order': 1, 'name': 'annualReport', 'ARFilingYear': 2024, 'enabled': True}, {'order': 3, 'name': 'annualReport', 'ARFilingYear': 2025, 'enabled': False}]),
    ...
    ('TA_3_AR_1_AR_2', 'BC1234567', Business.LegalTypes.BCOMP.value, datetime(1999, 7, 2, 8), datetime(2023, 7, 2, 8), datetime(2025, 9, 1), None, [{'order': 3, 'name': 'transition', 'enabled': False}, {'order': 1, 'name': 'annualReport', 'ARFilingYear': 2024, 'enabled': True}, {'order': 2, 'name': 'annualReport', 'ARFilingYear': 2025, 'enabled': False}]),
