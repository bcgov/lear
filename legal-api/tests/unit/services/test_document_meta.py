...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "BC1234567",
            2,
            {"nameRequest": {"nrNumber": "NR 8798956", "businessName": "HAULER MEDIA INC.", "legalType": "BC"}},
        ),
        (
            "COMPLETED",
            12356,
            "BC1234567",
            3,
            {"nameRequest": {"nrNumber": "NR 8798956", "businessName": "New Name.", "legalType": "BC"}},
        ),
    ...
    with app.app_context():
        filing = {
            "filing": {
                ...
                "business": {"identifier": "T12345678"},
                "incorporationApplication": {"nameRequest": {"legalType": LegalEntity.EntityTypes.BCOMP.value}},
            }
        }
        documents = document_meta.get_documents(filing)
        assert len(documents) == 1
...
@pytest.mark.parametrize("status, number_of_docs", [("COMPLETED", 3), ("CORRECTED", 3), ("UNKNOWN", 0)])
        ...
        with app.app_context():
            ...
            filing = {
                "filing": {
                    ...
                    "business": {"identifier": "BC1234567"},
                    "correction": {"correctedFilingId": original_filing.id},
                    "incorporationApplication": {"nameRequest": {"legalType": LegalEntity.EntityTypes.BCOMP.value}},
                }
            }
            ...
            filing = {
                "filing": {
                    ...
                    "incorporationApplication": {
                        "nameRequest": {"legalType": LegalEntity.EntityTypes.BCOMP.value, "nrNumber": "NR 3456789"}
                    },
                }
            }
            documents = document_meta.get_documents(filing)
