...
EXPECTED_DATA = {
    ...
    FilingKey.AMALGAMATION_REGULAR: {'name': 'amalgamation', 'type': 'regular', 'displayName': 'Regular Amalgamation', 'feeCode': 'AMARE'},
    FilingKey.AMALGAMATION_VERTICAL: {'name': 'amalgamation', 'type': 'vertical', 'displayName': 'Vertical Amalgamation', 'feeCode': 'AMAVE'},
    FilingKey.AMALGAMATION_HORIZONTAL: {'name': 'amalgamation', 'type': 'horizontal', 'displayName': 'Horizontal Amalgamation', 'feeCode': 'AMAHO'}
}
