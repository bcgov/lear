...
EXPECTED_DATA = {
    ...
    FilingKey.VOL_DISS: {'displayName': 'Voluntary Dissolution', 'feeCode': 'DIS_VOL',
                         'name': 'dissolution', 'type': 'voluntaryDissolution'},
    FilingKey.ADM_DISS: {'displayName': 'Administrative Dissolution', 'feeCode': 'DIS_ADM', 
                         'name': 'dissolution', 'type': 'administrativeDissolution'},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('staff_active_allowed', Business.State.ACTIVE, 'dissolution', 'voluntaryDissolution',
         ['CP', 'BC', 'BEN', 'CC', 'ULC', 'LLC', 'SP', 'GP'], 'staff', [STAFF_ROLE], True),

        ('staff_active_allowed', Business.State.ACTIVE, 'dissolution', 'administrativeDissolution',
         ['CP', 'BC', 'BEN', 'CC', 'ULC', 'LLC', 'SP', 'GP'], 'staff', [STAFF_ROLE], True),
        ...
        ('user_active_allowed', Business.State.ACTIVE, 'dissolution', 'voluntaryDissolution',
         ['CP', 'BC', 'BEN', 'CC', 'ULC', 'LLC', 'SP', 'GP'], 'general', [BASIC_USER], True),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('general_user_llc', True, Business.State.ACTIVE, ['LLC'], 'general', [BASIC_USER],
         expected_lookup([FilingKey.VOL_DISS])),
...
@pytest.mark.parametrize(
    ...
    [
        # active business - staff user
        ('staff_active_cp', Business.State.ACTIVE, ['CP'], 'staff', [STAFF_ROLE],
         expected_lookup([FilingKey.ADMN_FRZE, FilingKey.AR_CP, FilingKey.COA_CP, FilingKey.COD_CP, FilingKey.CORRCTN,
                          FilingKey.COURT_ORDER, FilingKey.VOL_DISS, FilingKey.ADM_DISS, FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER, FilingKey.SPECIAL_RESOLUTION])),
        ('staff_active_corps', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE],
         expected_lookup([FilingKey.ADMN_FRZE, FilingKey.ALTERATION, FilingKey.AR_CORPS, FilingKey.COA_CORPS, FilingKey.COD_CORPS,
                          FilingKey.CONTINUATION_OUT, FilingKey.CORRCTN, FilingKey.COURT_ORDER, FilingKey.VOL_DISS, FilingKey.ADM_DISS,
                          FilingKey.REGISTRARS_NOTATION, FilingKey.REGISTRARS_ORDER, FilingKey.TRANSITION])),
        ('staff_active_llc', Business.State.ACTIVE, ['LLC'], 'staff', [STAFF_ROLE],
         expected_lookup([FilingKey.ADMN_FRZE, FilingKey.COURT_ORDER, FilingKey.VOL_DISS, FilingKey.ADM_DISS,
                          FilingKey.REGISTRARS_NOTATION, FilingKey.REGISTRARS_ORDER])),
        ('staff_active_firms', Business.State.ACTIVE, ['SP', 'GP'], 'staff', [STAFF_ROLE],
         expected_lookup([FilingKey.ADMN_FRZE, FilingKey.CONV_FIRMS, FilingKey.COURT_ORDER, FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER])),

        # active business - general user
        ('general_user_cp', Business.State.ACTIVE, ['CP'], 'general', [BASIC_USER],
         expected_lookup([FilingKey.AR_CP, FilingKey.COA_CP, FilingKey.COD_CP, FilingKey.VOL_DISS, FilingKey.SPECIAL_RESOLUTION])),
        ('general_user_corps', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'general', [BASIC_USER],
         expected_lookup([FilingKey.ALTERATION, FilingKey.AR_CORPS, FilingKey.COA_CORPS, FilingKey.COD_CORPS, FilingKey.VOL_DISS,
                          FilingKey.TRANSITION])),
        ...
        ('staff_historical_corps', Business.State.HISTORICAL, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE],
         expected_lookup([FilingKey.COURT_ORDER, FilingKey.PUT_BACK_ON, FilingKey.REGISTRARS_NOTATION, FilingKey.REGISTRARS_ORDER,
                          FilingKey.RESTRN_FULL_CORPS, FilingKey.RESTRN_LTD_CORPS])),
        ('staff_historical_llc', Business.State.HISTORICAL, ['LLC'], 'staff', [STAFF_ROLE],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('staff_active_corps_valid_state_filing_success', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff',
         ...
         expected_lookup([FilingKey.ADMN_FRZE, FilingKey.ALTERATION, FilingKey.AR_CORPS, FilingKey.COA_CORPS, FilingKey.COD_CORPS,
                          FilingKey.CONTINUATION_OUT, FilingKey.CORRCTN, FilingKey.COURT_ORDER, FilingKey.VOL_DISS,
                          FilingKey.ADM_DISS, FilingKey.REGISTRARS_NOTATION, FilingKey.REGISTRARS_ORDER, FilingKey.TRANSITION,
                          FilingKey.RESTRN_LTD_EXT_CORPS, FilingKey.RESTRN_LTD_TO_FULL_CORPS])),
        ...
        ('staff_active_llc_valid_state_filing_success', Business.State.ACTIVE, ['LLC'], 'staff', [STAFF_ROLE],
         ...
         expected_lookup([FilingKey.ADMN_FRZE, FilingKey.COURT_ORDER, FilingKey.VOL_DISS, FilingKey.ADM_DISS, FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER, FilingKey.RESTRN_LTD_EXT_LLC, FilingKey.RESTRN_LTD_TO_FULL_LLC])),
        ...
        ('staff_active_firms_unaffected', Business.State.ACTIVE, ['SP', 'GP'], 'staff', [STAFF_ROLE],
         ...
         expected_lookup([FilingKey.ADMN_FRZE, FilingKey.CHANGE_OF_REGISTRATION, FilingKey.CONV_FIRMS, FilingKey.CORRCTN_FIRMS,
                          FilingKey.COURT_ORDER, FilingKey.VOL_DISS_FIRMS, FilingKey.ADM_DISS_FIRMS, FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER])),
