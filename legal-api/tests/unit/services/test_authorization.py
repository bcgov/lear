    ...
    [
        ...
        ('staff_active_cp', Business.State.ACTIVE, 'CP', 'staff', [STAFF_ROLE],
         ['annualReport', 'changeOfAddress', 'changeOfDirectors', 'correction', 'courtOrder',
          'dissolution', 'incorporationApplication', 'specialResolution', 'registrarsNotation', 'registrarsOrder']),
        ('staff_active_bc', Business.State.ACTIVE, 'BC', 'staff', [STAFF_ROLE],
         ['alteration', 'annualReport', 'changeOfAddress', 'changeOfDirectors', 'correction', 'courtOrder',
          'dissolution', 'incorporationApplication', 'transition', 'registrarsNotation', 'registrarsOrder']),
        ...
        ('staff_active_llc', Business.State.ACTIVE, 'LLC', 'staff', [STAFF_ROLE],
         ['courtOrder', 'dissolution', 'registrarsNotation', 'registrarsOrder']),
        ...
        ('user_active_sp', Business.State.ACTIVE, 'SP', 'user', [BASIC_USER],
         ['changeOfRegistration', 'dissolution', 'registration']),
        ('user_active_gp', Business.State.ACTIVE, 'GP', 'user', [BASIC_USER],
         ['changeOfRegistration', 'dissolution', 'registration']),

        # historical business
        ('staff_historical_cp', Business.State.HISTORICAL, 'CP', 'staff', [STAFF_ROLE],
         ['courtOrder', 'registrarsNotation', 'registrarsOrder',
         {'restoration': ['fullRestoration']}, 'putBackOn', 'adminFreeze']),
        ('staff_historical_bc', Business.State.HISTORICAL, 'BC', 'staff', [STAFF_ROLE],
         ['courtOrder', 'registrarsNotation', 'registrarsOrder',
         {'restoration': ['fullRestoration', 'limitedRestoration']}, 'putBackOn', 'adminFreeze']),
        ...
        ('staff_historical_sp', Business.State.HISTORICAL, 'SP', 'staff', [STAFF_ROLE],
         ['courtOrder', 'registrarsNotation', 'registrarsOrder', {'restoration': []}, 'putBackOn', 'adminFreeze']),
