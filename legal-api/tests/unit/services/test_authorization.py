...
class FilingKey(str, Enum):
    ...
    CHANGE_OF_RECEIVERS_AMMEND = 'CHANGE_OF_RECEIVERS_AMMEND'
...
EXPECTED_DATA = {
    ...
    FilingKey.CHANGE_OF_RECEIVERS_AMMEND: {'name': 'changeOfReceivers', 'type': 'ammendReceiver', 'displayName': 'Ammend Receiver Information', 'feeCode': 'NOCRM'},
    ...
    [
        ...
        ('staff_active_corps', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE],
         ['adminFreeze', 'agmExtension', 'agmLocationChange', 'alteration',
          ...
          'ceaseReceiver', 'changeOfAddress', 'changeOfDirectors', 'changeOfOfficers', 'consentAmalgamationOut', 'consentContinuationOut', 'continuationOut',
        ...
        ('staff_active_continue_in_corps', Business.State.ACTIVE, ['C', 'CBEN', 'CUL', 'CCC'], 'staff', [STAFF_ROLE],
         ['adminFreeze', 'agmExtension', 'agmLocationChange', 'alteration',
          {'amalgamationApplication': ['regular', 'vertical', 'horizontal']}, 'amalgamationOut', 'annualReport', 'appointReceiver',
          'ceaseReceiver', 'changeOfAddress', 'changeOfDirectors', 'changeOfOfficers', 'continuationIn', 'consentAmalgamationOut', 'consentContinuationOut',
    ...
    [
        ...
        ('staff_active_corps', True, Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE],
         expected_lookup([FilingKey.ADMN_FRZE,
                          ...
                          FilingKey.AR_CORPS,
                          FilingKey.CHANGE_OF_RECEIVERS_AMMEND,
