...
class FilingKey(str, Enum):
    ...
    CHANGE_OF_RECEIVERS_APPOINT = 'CHANGE_OF_RECEIVERS_APPOINT'
    CHANGE_OF_RECEIVERS_CEASE = 'CHANGE_OF_RECEIVERS_CEASE'
    CHANGE_OF_RECEIVERS_ADDRESS = 'CHANGE_OF_RECEIVERS_ADDRESS'
    CHANGE_OF_RECEIVERS_AMEND = 'CHANGE_OF_RECEIVERS_AMEND'
    CHANGE_OF_LIQUIDATORS_APPOINT = 'CHANGE_OF_LIQUIDATORS_APPOINT'
    CHANGE_OF_LIQUIDATORS_CEASE = 'CHANGE_OF_LIQUIDATORS_CEASE'
    CHANGE_OF_LIQUIDATORS_ADDRESS = 'CHANGE_OF_LIQUIDATORS_ADDRESS'
    CHANGE_OF_LIQUIDATORS_INTENT = 'CHANGE_OF_LIQUIDATORS_INTENT'
    CHANGE_OF_LIQUIDATORS_REPORT = 'CHANGE_OF_LIQUIDATORS_REPORT'
...
EXPECTED_DATA = {
    ...
    FilingKey.COO_CORPS: {'displayName': 'Officer Change', 'feeCode': 'NOCOI', 'name': 'changeOfOfficers'},
    ...
    FilingKey.ADM_DISS_FIRMS: {'displayName': 'Statement of Dissolution', 'feeCode': 'DIS_ADM',
                               'name': 'dissolution', 'type': 'administrative'},
    FilingKey.DELAY_DISS: {'displayName': 'Delay of Dissolution', 'feeCode': 'DISDE',
                               'name': 'dissolution', 'type': 'delay'},
    ...
    FilingKey.TRANSITION: {'displayName': 'Post Restoration Transition Application', 'feeCode': 'TRANP', 'name': 'transition'},
    ...
    FilingKey.CHANGE_OF_LIQUIDATORS_APPOINT: {'name': 'changeOfLiquidators', 'type': 'appointLiquidator', 'displayName': 'Notice of Appointment of Liquidator', 'feeCode': 'NOAPL'},
    FilingKey.CHANGE_OF_LIQUIDATORS_CEASE: {'name': 'changeOfLiquidators', 'type': 'ceaseLiquidator', 'displayName': 'Notice of Ceasing to Act as Liquidator', 'feeCode': 'NOCEL'},
    FilingKey.CHANGE_OF_LIQUIDATORS_ADDRESS: {'name': 'changeOfLiquidators', 'type': 'changeAddressLiquidator', 'displayName': 'Notice of Change of Address of Liquidator and/or Liquidation Records Office', 'feeCode': 'NOCAL'},
    FilingKey.CHANGE_OF_LIQUIDATORS_INTENT: {'name': 'changeOfLiquidators', 'type': 'intentToLiquidate', 'displayName': 'Statement of Intent to Liquidate', 'feeCode': 'LQSIN'},
    FilingKey.CHANGE_OF_LIQUIDATORS_REPORT: {'name': 'changeOfLiquidators', 'type': 'liquidationReport', 'displayName': 'Liquidation Report', 'feeCode': 'LIQUR'},
}
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('staff_active_cp', Business.State.ACTIVE, ['CP'], 'staff', [STAFF_ROLE],
         ['adminFreeze', 'annualReport', 'changeOfAddress', 'changeOfDirectors', 'changeOfOfficers', 'correction', 'courtOrder',
          {'dissolution': ['voluntary', 'administrative', 'delay']}, 'incorporationApplication',
        ...
        ('staff_active_corps', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE],
         ['adminFreeze', 'agmExtension', 'agmLocationChange', 'alteration',
          ...
          'changeOfAddress', 'changeOfDirectors', {'changeOfLiquidators': ['appointLiquidator', 'ceaseLiquidator', 'changeAddressLiquidator', 'intentToLiquidate', 'liquidationReport']},
          'changeOfOfficers', {'changeOfReceivers': ['amendReceiver', 'appointReceiver', 'ceaseReceiver', 'changeAddressReceiver']},
          'consentAmalgamationOut', 'consentContinuationOut', 'continuationOut',
          'correction', 'courtOrder', {'dissolution': ['voluntary', 'administrative', 'delay']},
        ...
        ('staff_active_continue_in_corps', Business.State.ACTIVE, ['C', 'CBEN', 'CUL', 'CCC'], 'staff', [STAFF_ROLE],
         ['adminFreeze', 'agmExtension', 'agmLocationChange', 'alteration',
          ...
          'continuationOut', 'correction', 'courtOrder', {'dissolution': ['voluntary', 'administrative', 'delay']},
        ...
        ('user_active_cp', Business.State.ACTIVE, ['CP'], 'general', [BASIC_USER],
         ['annualReport', 'changeOfAddress', 'changeOfDirectors', 'changeOfOfficers',
          {'dissolution': ['voluntary', 'delay']}, 'incorporationApplication', 'specialResolution']),
        ('user_active_corps', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'general', [BASIC_USER],
         ['agmExtension', 'agmLocationChange', 'alteration', {'amalgamationApplication': ['regular', 'vertical', 'horizontal']},
          'annualReport', 'changeOfAddress', 'changeOfDirectors', 'changeOfOfficers', 'consentAmalgamationOut', 'consentContinuationOut',
          {'dissolution': ['voluntary', 'delay']}, 'incorporationApplication', 'transition', {'transparencyRegister': ['annual', 'change', 'initial']}]),
        ('user_active_continue_in_corps', Business.State.ACTIVE, ['C', 'CBEN', 'CUL', 'CCC'], 'general', [BASIC_USER],
         ['agmExtension', 'agmLocationChange', 'alteration', {'amalgamationApplication': ['regular', 'vertical', 'horizontal']},
          'annualReport', 'changeOfAddress', 'changeOfDirectors', 'changeOfOfficers', 'consentAmalgamationOut', 'consentContinuationOut', 'continuationIn',
          {'dissolution': ['voluntary', 'delay']}, 'transition', {'transparencyRegister': ['annual', 'change', 'initial']}]),
        ...
        ('staff_historical_corps', Business.State.HISTORICAL, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE],
         ['correction', 'courtOrder', 'putBackOn', 'registrarsNotation', 'registrarsOrder',
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('user_active', Business.State.ACTIVE, 'consentAmalgamationOut', None,
         ['BC', 'BEN', 'ULC', 'CC', 'C', 'CBEN', 'CUL', 'CCC'], 'general', [BASIC_USER], True),
        ...
        ('staff_historical', Business.State.HISTORICAL, 'correction', None,
         ['CP', 'LLC', 'SP', 'GP'], 'staff', [STAFF_ROLE], False),

        ('staff_historical_allowed', Business.State.HISTORICAL, 'correction', None,
         ['BC', 'BEN', 'CC', 'ULC', 'C', 'CBEN', 'CUL', 'CCC'], 'staff', [STAFF_ROLE], True),
        ...
        ('user_historical', Business.State.HISTORICAL, 'consentAmalgamationOut', None,
         ['BC', 'BEN', 'ULC', 'CC', 'C', 'CBEN', 'CUL', 'CCC'], 'general', [BASIC_USER], False),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('staff_historical_corps', True, Business.State.HISTORICAL, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE],
         expected_lookup([FilingKey.CORRCTN,
                          FilingKey.COURT_ORDER,
                          FilingKey.PUT_BACK_ON,
                          FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER,
    ...
    with jwt_request_context(app, jwt, roles=roles, username=username, account_id=account_id):
        ...
        for legal_type in legal_types:
            ...
            if legal_type in Business.CORPS:
                if state == Business.State.ACTIVE:
                    assert result["arReminder"] == True
                else:
                    assert result["arReminder"] == False
            else:
                assert "arReminder" not in result
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('general_user_corps', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'general', [BASIC_USER],
         BLOCKER_FILING_STATUSES, expected_lookup([FilingKey.TRANSPARENCY_REGISTER_ANNUAL,
                                                   FilingKey.TRANSPARENCY_REGISTER_CHANGE,
                                                   FilingKey.TRANSPARENCY_REGISTER_INITIAL])),
        ('general_user_continue_in_corps', Business.State.ACTIVE, ['C', 'CBEN', 'CCC', 'CUL'], 'general', [BASIC_USER],
         BLOCKER_FILING_STATUSES,
         expected_lookup_continue_in_corps([FilingKey.TRANSPARENCY_REGISTER_ANNUAL,
                                            FilingKey.TRANSPARENCY_REGISTER_CHANGE,
                                            FilingKey.TRANSPARENCY_REGISTER_INITIAL])),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('general_user_corps', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'general', [BASIC_USER],
         BLOCKER_FILING_TYPES, BLOCKER_FILING_STATUSES_AND_ADDITIONAL,
         expected_lookup([FilingKey.TRANSPARENCY_REGISTER_ANNUAL,
                          FilingKey.TRANSPARENCY_REGISTER_CHANGE,
                          FilingKey.TRANSPARENCY_REGISTER_INITIAL])),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('staff_historical_corps_invalid_state_filing_fail', Business.State.HISTORICAL, ['BC', 'BEN', 'CC', 'ULC'],
         'staff', [STAFF_ROLE], ['amalgamationOut', 'continuationOut'], [None, None],
         expected_lookup([FilingKey.CORRCTN,
                          FilingKey.COURT_ORDER,
                          FilingKey.PUT_BACK_ON,
                          FilingKey.REGISTRARS_NOTATION,
        ...
        ('staff_historical_continue_in_corps_invalid_state_filing_fail', Business.State.HISTORICAL,
         ['C', 'CBEN', 'CCC', 'CUL'], 'staff', [STAFF_ROLE], ['amalgamationOut', 'continuationOut'], [None, None],
         expected_lookup([FilingKey.CORRCTN,
                          FilingKey.COURT_ORDER,
                          FilingKey.PUT_BACK_ON,
                          FilingKey.REGISTRARS_NOTATION,
...
@pytest.mark.parametrize(
    'test_name,business_exists,state,legal_types,username,roles,num_dods,expected',
    [
        # active business - staff user
        ('staff_active_cp', True, Business.State.ACTIVE, ['CP'], 'staff', [STAFF_ROLE], 0,
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.AR_CP,
                          FilingKey.COA_CP,
                          FilingKey.COD_CP,
                          ...
                          FilingKey.REGISTRARS_ORDER,
                          FilingKey.SPECIAL_RESOLUTION])),
        ('staff_active_corps', True, Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE], 0,
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.AR_CORPS,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
        ...
        ('staff_active_corps_2_dods', True, Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE], 2,
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.AR_CORPS,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
        ...
        ('staff_active_llc', True, Business.State.ACTIVE, ['LLC'], 'staff', [STAFF_ROLE], 0, []),
        ('staff_active_firms', True, Business.State.ACTIVE, ['SP', 'GP'], 'staff', [STAFF_ROLE], 0,
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.CHANGE_OF_REGISTRATION,
                          FilingKey.CONV_FIRMS,
                          FilingKey.CORRCTN_FIRMS,
        ...
        # active business - general user
        ('general_user_cp', True, Business.State.ACTIVE, ['CP'], 'general', [BASIC_USER], 0,
         expected_lookup([FilingKey.AR_CP,
                          FilingKey.COA_CP,
                          FilingKey.COD_CP,
                          FilingKey.COO_CORPS,
                          FilingKey.DELAY_DISS])),
        ('general_user_corps', True, Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'general', [BASIC_USER], 0,
         expected_lookup([FilingKey.AR_CORPS,
                          ...
                          FilingKey.TRANSPARENCY_REGISTER_CHANGE,
                          FilingKey.TRANSPARENCY_REGISTER_INITIAL])),
        ('general_user_corps_1_dod', True, Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'general', [BASIC_USER], 1,
         expected_lookup([FilingKey.AR_CORPS,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
                          FilingKey.COO_CORPS,
                          ...
                          FilingKey.TRANSPARENCY_REGISTER_CHANGE,
                          FilingKey.TRANSPARENCY_REGISTER_INITIAL])),
        ('general_user_corps_2_dods', True, Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'general', [BASIC_USER], 2,
         expected_lookup([FilingKey.AR_CORPS,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
                          FilingKey.COO_CORPS,
                          ...
                          FilingKey.TRANSPARENCY_REGISTER_CHANGE,
                          FilingKey.TRANSPARENCY_REGISTER_INITIAL])),
        ('general_user_llc', True, Business.State.ACTIVE, ['LLC'], 'general', [BASIC_USER], 0, []),
        ('general_user_firms', True, Business.State.ACTIVE, ['SP', 'GP'], 'general', [BASIC_USER], 0,
         expected_lookup([FilingKey.CHANGE_OF_REGISTRATION])),

        # historical business - staff user
        ('staff_historical_cp', True, Business.State.HISTORICAL, ['CP'], 'staff', [STAFF_ROLE], 0,
         expected_lookup([FilingKey.COURT_ORDER,
                          FilingKey.PUT_BACK_ON,
                          FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER])),
        ('staff_historical_corps', True, Business.State.HISTORICAL, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE], 0,
         expected_lookup([FilingKey.CORRCTN,
                          FilingKey.COURT_ORDER,
                          FilingKey.PUT_BACK_ON,
                          FilingKey.REGISTRARS_NOTATION,
                          ...
                          FilingKey.RESTRN_FULL_CORPS,
                          FilingKey.RESTRN_LTD_CORPS])),
        ('staff_historical_llc', True, Business.State.HISTORICAL, ['LLC'], 'staff', [STAFF_ROLE], 0, []),
        ('staff_historical_firms', True, Business.State.HISTORICAL, ['SP', 'GP'], 'staff', [STAFF_ROLE], 0,
         expected_lookup([FilingKey.COURT_ORDER,
                          FilingKey.PUT_BACK_ON,
                          FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER])),
        ...
        # historical business - general user
        ('general_user_historical_cp', True, Business.State.HISTORICAL, ['CP'], 'general', [BASIC_USER], 0, []),
        ('general_user_historical_corps', True, Business.State.HISTORICAL, ['BC', 'BEN', 'CC', 'ULC'], 'general',
         [BASIC_USER], 0, []),
        ('general_user_historical_llc', True, Business.State.HISTORICAL, ['LLC'], 'general', [BASIC_USER], 0, []),
        ('general_user_historical_firms', True, Business.State.HISTORICAL, ['SP', 'GP'], 'general', [BASIC_USER], 0, []),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        # active business - staff user
        ('staff_active_corps_none_enabled', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE], '',
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.ALTERATION,
                          FilingKey.AR_CORPS,
                          FilingKey.COA_CORPS,
                          ...
                          FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER,])),
        ('staff_active_corps_receivers_enabled', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE], 'changeOfReceivers.amendReceiver,changeOfReceivers.appointReceiver,changeOfReceivers.ceaseReceiver,changeOfReceivers.changeAddressReceiver',
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.ALTERATION,
                          FilingKey.AR_CORPS,
                          FilingKey.COA_CORPS,
                          ...
                          FilingKey.REGISTRARS_NOTATION,
                          FilingKey.REGISTRARS_ORDER,])),
        ('staff_active_corps_liquidators_partial_enabled', Business.State.ACTIVE, ['BC', 'BEN', 'CC', 'ULC'], 'staff', [STAFF_ROLE], 'changeOfLiquidators.appointLiquidator,changeOfLiquidators.ceaseLiquidator,changeOfLiquidators.changeAddressLiquidator,changeOfLiquidators.intentToLiquidate',
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.ALTERATION,
                          FilingKey.AR_CORPS,
                          FilingKey.COA_CORPS,
...
@pytest.mark.parametrize(
    'test_name,username,roles,in_liquidation_date,last_lr_year,expected',
    [
        ('staff_allowed_all_1', 'staff', [STAFF_ROLE], datetime.now() - datedelta(years=2), None,
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.ALTERATION,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
        ...
        ('staff_allowed_no_lr_1', 'staff', [STAFF_ROLE], datetime.now() - datedelta(years=2), datetime.now().year,
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.ALTERATION,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
        ...
        ('staff_allowed_no_lr_2', 'staff', [STAFF_ROLE], datetime.now(), None,
         expected_lookup([FilingKey.ADMN_FRZE,
                          FilingKey.ALTERATION,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
        ...
        ('basic_user_not_allowed',
         'basic_user',
         [BASIC_USER],
         datetime.now() - datedelta(years=2),
         None,
         expected_lookup([FilingKey.ALTERATION,
                          FilingKey.COA_CORPS,
                          FilingKey.COD_CORPS,
