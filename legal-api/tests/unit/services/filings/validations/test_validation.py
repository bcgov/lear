...
def test_validate_coa_basic(session, test_name, now, delivery_region, delivery_country, mailing_region, mailing_country,
    ...
    f['filing']['changeOfAddress']['deliveryAddress']['addressRegion'] = delivery_region
    f['filing']['changeOfAddress']['deliveryAddress']['addressCountry'] = delivery_country
    f['filing']['changeOfAddress']['mailingAddress']['addressRegion'] = mailing_region
    f['filing']['changeOfAddress']['mailingAddress']['addressCountry'] = mailing_country
    # perform test
    with freeze_time(now):
