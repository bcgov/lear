...
@pytest.mark.parametrize(
    ...
    [
        ('SUCCESS_FIRST_AGM_FIRST_EXT', '2023-10-01', {'year': '2023','isFirstAgm': True, 'extReqForAgmYear': False}, None, None),
        ('FAIL_FIRST_AGM_FIRST_EXT_TOO_LATE', '2020-10-01', {'year': '2023','isFirstAgm': True, 'extReqForAgmYear': False},
         HTTPStatus.BAD_REQUEST, 'Company failed to request the extension in time.'),
        ('SUCCESS_FIRST_AGM_MORE_EXT', '2022-10-01', {'year': '2023','isFirstAgm': True, 'extReqForAgmYear': True, 'expireDateCurrExt': '2024-10-01'}, None, None),
        ...
        ('SUCCESS_SUBSEQUENT_AGM_FIRST_EXT', '2020-10-01', {'year': '2023','isFirstAgm': False, 'extReqForAgmYear': False, 'prevAgmRefDate':'2023-10-01'}, None, None),
        ...
        ('SUCCESS_SUBSEQUENT_AGM_MORE_EXT', '2022-10-01',
         {'year': '2023','isFirstAgm': False, 'extReqForAgmYear': True, 'prevAgmRefDate':'2023-06-01', 'expireDateCurrExt':'2024-03-01'}, None, None),
