...
from . import create_officer, create_party, create_party_address, lists_are_equal
...
nr_response = {
    "state": "APPROVED",
    "expirationDate": "",
    "names": [{"name": legal_name, "state": "APPROVED", "consumptionDate": ""}],
}


@pytest.mark.parametrize(
    "test_name, entity_type, delivery_region, delivery_country, mailing_region, mailing_country, expected_code,\
     expected_msg",
    [
...
def test_validate_incorporation_addresses_basic(
    ...
    mocker.patch(
        "legal_api.services.filings.validations.incorporation_application.validate_name_request", return_value=[]
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            HTTPStatus.BAD_REQUEST,
            [{"error": "Must have a minimum of 1 Director", "path": "/filing/incorporationApplication/parties/roles"}],
        ),
        (
            "FAIL_ATLEAST_ONE_DIRECTOR",
            "BC",
        ...
        (
            ...
            HTTPStatus.BAD_REQUEST,
            [{"error": "Must have a minimum of 3 Director", "path": "/filing/incorporationApplication/parties/roles"}],
        ),
        (
            "SUCCESS",
            "CP",
        ...
        (
            ...
            [
                {
                    "error": "Incorporator is an invalid party role",
                    "path": "/filing/incorporationApplication/parties/roles",
                }
            ],
        ),
        (
            "FAIL_MINIMUM_3_DIRECTORS",
            "CP",
            [
                {"partyName": "officer1", "roles": ["Completing Party", "Director"]},
                {"partyName": "officer2", "roles": ["Director"]},
            ...
            [
                {
                    "error": "Must have a minimum of three Directors",
                    "path": "/filing/incorporationApplication/parties/roles",
                }
            ],
        ),
...
def test_validate_incorporation_role(
    session, minio_server, mocker, test_name, legal_type, parties, expected_code, expected_msg
):
    ...
    if legal_type == "CP":
        ...
        filing_json["filing"][incorporation_application_name]["cooperative"] = {"cooperativeAssociationType": "CP"}

        # Provide mocked valid documents
        filing_json["filing"][incorporation_application_name]["cooperative"]["rulesFileKey"] = _upload_file(
            letter, invalid=False
        )
        filing_json["filing"][incorporation_application_name]["cooperative"]["memorandumFileKey"] = _upload_file(
            letter, invalid=False
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "FAIL_MAJORITY_IN_COUNTRY_CA_50_percent",
            "CP",
            [
                {
                    "partyName": "officer1",
...
def test_validate_incorporation_parties_mailing_address(session, mocker, test_name, legal_type, parties, expected_msg):
    ...
    for index, party in enumerate(parties):
        ...
        mailing_addr = create_party_address(
            street=party_ma["street"],
...
@pytest.mark.parametrize(
    ...
    [
        (
            "SUCCESS_VALID_FIRST_MIDDLE_NAME_LENGTHS",
            "BEN",
            [
                {
                    "partyName": "officer1",
        ...
        (
            "FAIL_PARTY_FIRST_NAME_TOO_LONG",
            "BEN",
            [
                {
                    "partyName": "officer1",
        ...
        (
            "FAIL_PARTY_MIDDLE_NAME_TOO_LONG",
            "BEN",
            [
                {
                    "partyName": "officer1",
        ...
        (
            "FAIL_PARTY_FIRST_AND_MIDDLE_NAME_TOO_LONG",
            "BEN",
            [
                {
                    "partyName": "officer1",
                    "roles": ["Completing Party", "Incorporator"],
                    "officer": {
                        "firstName": "Janeajksdfjljdkslfjab",
            ...
            [
                {
                    ...
                    "roles": ["Completing Party", "Director"],
                    "officer": {
                        "firstName": "Johnajksdfjljdkslfjab",
                        "middleName": "Johnajksdfjljdkslfjab",
                        "lastName": "Doe",
                    },
                },
                {
                    ...
                    "roles": ["Director"],
                    "officer": {
                        "firstName": "Jane1jksdfjljdkslfjab",
                        "middleName": "Jane1ajksdfjljdkslfjab",
                        "lastName": "Doe",
                    },
                },
                {
                    ...
                    "roles": ["Director"],
                    "officer": {
                        "firstName": "Jane2jksdfjljdkslfjab",
                        "middleName": "Jane2ajksdfjljdkslfjab",
                        "lastName": "Doe",
                    },
                },
            ],
...
def test_validate_incorporation_party_names(session, mocker, test_name, legal_type, parties, expected_msg):
    """Assert that incorporation parties roles can be validated."""
    filing_json = copy.deepcopy(INCORPORATION_FILING_TEMPLATE)
    filing_json["filing"]["header"] = {
        "name": incorporation_application_name,
    ...
    for index, party in enumerate(parties):
        ...
        officer = create_officer(
            base_officer=base_officer_copy, first_name=first_name, middle_name=middle_name, last_name=last_name
        )
...
def test_validate_incorporation_share_classes(
    ...
    legal_type,
    class_name_1,
    class_has_max_shares,
    class_max_shares,
    has_par_value,
    par_value,
    currency,
    series_name_1,
    series_has_max_shares,
    series_max_shares,
    class_name_2,
    series_name_2,
    expected_code,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "FAIL_INVALID_DATE_TIME_FORMAT",
            "2020-09-18T00:00:00",
            HTTPStatus.UNPROCESSABLE_ENTITY,
            [
                {
                    "context": [],
                    "error": "'2020-09-18T00:00:00' is not a 'date-time'",
                    "path": "filing/header/effectiveDate",
                }
            ],
        ),
        (
            "FAIL_INVALID_DATE_TIME_MINIMUM",
            "2020-09-17T00:01:00+00:00",
            HTTPStatus.BAD_REQUEST,
            [{"error": "Invalid Datetime, effective date must be a minimum of 2 minutes ahead."}],
        ),
        (
            "FAIL_INVALID_DATE_TIME_MAXIMUM",
            "2020-09-27T00:01:00+00:00",
            HTTPStatus.BAD_REQUEST,
...
@pytest.mark.parametrize("test_name", [("with_court_order"), ("without_court_order")])
