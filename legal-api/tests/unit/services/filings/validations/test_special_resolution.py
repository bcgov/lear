...
@pytest.mark.parametrize(
    "test_name, resolution, identifier, resolution_date, signing_date, signatory_given_name, signatory_family_name,\
    business_founding_date, expected_code, expected_msg",
    [
        (
            "SUCCESS",
            "some resolution",
        ...
        (
            ...
            "2010-01-10",
            HTTPStatus.BAD_REQUEST,
            "Resolution must be 2MB or less.",
        ),
        (
            "INVALID - resolution date < incorp date",
            "some resolution",
            "CP1234567",
            "2009-01-10",
            "2021-01-10",
            ...
            "2010-01-10",
            HTTPStatus.BAD_REQUEST,
            "Resolution date cannot be earlier than the incorporation date.",
        ),
        (
            "INVALID - resolution date is future date",
            "some resolution",
            "CP1234567",
            create_utc_future_date_str(days=10),
            "2021-01-10",
            "jane",
            "doe",
            "2010-01-10",
        ...
        (
            "INVALID - signing date is future date",
            "some resolution",
            "CP1234567",
            "2010-01-10",
            create_utc_future_date_str(days=10),
        ...
        (
            "INVALID - signing date before resolution date",
            "some resolution",
            "CP1234567",
            "2010-01-10",
            "2010-01-09",
            ...
            "2010-01-10",
            HTTPStatus.BAD_REQUEST,
            "Signing date cannot be before the resolution date.",
        ),
        (
            "SUCCESS - signing & resolution date are same",
            "some resolution",
            "CP1234567",
            "2010-01-10",
            "2010-01-10",
        ...
        (
            "SUCCESS - signing after resolution date",
            "some resolution",
            "CP1234567",
            "2010-01-10",
            "2010-01-11",
        ...
        (
            ...
            "2010-01-10",
            HTTPStatus.BAD_REQUEST,
            "Signatory given name is required.",
        ),
        (
            "MISSING - signatory last name",
            "some resolution",
            "CP1234567",
            "2021-01-10",
            "2021-01-10",
            ...
            "2010-01-10",
            HTTPStatus.BAD_REQUEST,
            "Signatory family name is required.",
        ),
    ],
...
def test_validate(
    ...
    resolution_date,
    signing_date,
    signatory_given_name,
    signatory_family_name,
