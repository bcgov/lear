...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "region",
            BusinessWarningReferers.BUSINESS_OFFICE,
            "NO_BUSINESS_OFFICE_MAILING_ADDRESS_REGION",
            "Region is required for business office mailing address.",
        ),
        ...
        (
            ...
            "region",
            BusinessWarningReferers.BUSINESS_PARTY,
            "NO_BUSINESS_PARTY_MAILING_ADDRESS_REGION",
            "Region is required for business party mailing address.",
        ),
        ...
        (
            ...
            "region",
            BusinessWarningReferers.COMPLETING_PARTY,
            "NO_COMPLETING_PARTY_MAILING_ADDRESS_REGION",
            "Region is required for completing party mailing address.",
        ),
    ],
)
