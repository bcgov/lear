...
def factory_party_role_organization(role: EntityRole.RoleTypes,
    ...
    if legal_entity:
        ...
        party_role.legal_entity_id = legal_entity.id
    if custom_org_id:
        related_colin_entity = factory_party_organization('test business name', 'FM1112222', custom_org_id)
        party_role.related_colin_entity = related_colin_entity
        party_role.related_colin_entity_id = related_colin_entity.id
    else:
        party_role.related_colin_entity = factory_party_organization('test business name', 'FM1112222')
    return party_role
