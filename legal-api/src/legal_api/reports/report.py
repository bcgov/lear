...
from legal_api.models import CorpType, Document, EntityRole, Filing, LegalEntity
...
class Report:  # pylint: disable=too-few-public-methods, too-many-lines
    ...
    def _get_report_filename(self):
        ...
        legal_entity_number = self._legal_entity.identifier if self._legal_entity else \
    ...
    def _get_template_data(self):  # pylint: disable=too-many-branches
        if self._report_key in ['noticeOfArticles', 'amendedRegistrationStatement', 'correctedRegistrationStatement']:
            filing = VersionedBusinessDetailsService.get_company_details_revision(self._filing.id,
    ...
    def _set_description(self, filing):
        ...
        act = {
            LegalEntity.EntityTypes.BCOMP.value: 'Business Corporations Act',
            LegalEntity.EntityTypes.COMP.value: 'Business Corporations Act',
            LegalEntity.EntityTypes.BC_CCC.value: 'Business Corporations Act',
            LegalEntity.EntityTypes.BC_ULC_COMPANY.value: 'Business Corporations Act',
