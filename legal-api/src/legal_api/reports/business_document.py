...
class BusinessDocument:
    ...
    def _set_warning(self, business: dict):
        ...
        if self._business.backfill_cutoff_filing_id:
            ...
            business["warning_text"] = f"Warning, data older than {LegislationDatetime.format_as_report_string(filing.filing_date)} may not appear in the Business Summary"
    ...
    def _set_business_changes(self, business: dict):
        ...
        for filing in Filing.get_filings_by_types(self._business.id, ["alteration", "correction", "changeOfName",
            ...
            if filing_meta:
                ...
                elif filing_changes.get("fromLegalName") or filing.filing_type == "changeOfName":
                    name_change_info = {}
    ...
    def _set_meta_info(self, business: dict):
        ...
        business["meta_subject"] = f"{self._business.legal_name} ({self._business.identifier})"
