...
class LegislationDatetime:
    ...
    def format_as_report_string_with_custom_time(
        date_time: datetime, custom_hour: int, custom_minute: int, custom_second: int, custom_microsecond: int
    ) -> str:
        """Return a datetime string in this format (eg: `August 5, 2021 at 11:00 am Pacific time`).
        ...
        date_time = date_time.replace(
            hour=custom_hour, minute=custom_minute, second=custom_second, microsecond=custom_microsecond
        )
