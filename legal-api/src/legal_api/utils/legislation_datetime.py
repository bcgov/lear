...
class LegislationDatetime():
    ...
    def now() -> datetime:
        ...
        return datetime.utcnow().astimezone(pytz.timezone(current_app.config.get('LEGISLATIVE_TIMEZONE')))
    ...
    @staticmethod
    def as_legislation_timezone_from_date(_date: date) -> Optional[date]:
