...
def get_bn_request_trackers(identifier: str):
    ...
    request_trackers = RequestTracker.find_by(business, RequestTracker.ServiceName.BN_HUB)
    return (
        jsonify(
            {
                "requestTrackers": [
...
def resubmit_bn_request(identifier: str):
    ...
    request_tracker = RequestTracker(
        ...
        legal_entity_id=business.id if business.is_legal_entity else None,
...
def get_request_tracker(request_tracker_id: int):
    ...
    return (
        jsonify(
            {
                "request": request_tracker.request_object,
                "response": request_tracker.response_object,
                **request_tracker.json,
            }
        ),
        HTTPStatus.OK,
