...
def get_identifiers_of_expired_restoration():
    ...
    return jsonify(
        {
            "businesses": [
                {"identifier": business.identifier, "legalType": business.legal_type} for business in businesses
            ]
        }
    ), HTTPStatus.OK
...
def create_registrars_notation_filing(business: Business, user: User, old_bn: str):
    ...
    filing.filing_json = {
        "filing": {
            ...
            "business": {"identifier": business.identifier, "legalType": business.legal_type},
            "registrarsNotation": {
