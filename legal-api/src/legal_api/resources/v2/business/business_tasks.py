...
from legal_api.services import check_business, namex
...
def construct_task_list(business):  # pylint: disable=too-many-locals; only 2 extra
    ...
    business_warnings = check_business(business)
    if len(business_warnings) > 0:
        ...
        business.compliance_warnings = business_warnings
        business.warnings = business_warnings
