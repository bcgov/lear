...
class NrTypeMap(Resource):
    ...
    def get():
        ...
        request_type_mapping = [
            ...
            # (RequestActions.AS, Business.LegalTypes.XPRO_CORPORATION.value, RequestActions.AS.value),
            # ('LC', Business.LegalTypes.XPRO_LIMITED_LIABILITY_COMPANY.value, RequestActions.NEW.value),
            # ('CLC', Business.LegalTypes.XPRO_LIMITED_LIABILITY_COMPANY.value, RequestActions.CHG.value),
            # ('RLC', Business.LegalTypes.XPRO_LIMITED_LIABILITY_COMPANY.value, RequestActions.REST.value),
            # ('RLC', Business.LegalTypes.XPRO_LIMITED_LIABILITY_COMPANY.value, RequestActions.REN.value),
            # ('RLC', Business.LegalTypes.XPRO_LIMITED_LIABILITY_COMPANY.value, RequestActions.REH.value),
            # ('AL', Business.LegalTypes.XPRO_LIMITED_LIABILITY_COMPANY.value, RequestActions.AS.value),
            # ('FR', Business.LegalTypes.FIRM.value, RequestActions.NEW.value),
            # ('FR', Business.LegalTypes.SOLE_PROPRIETORSHIP.value, RequestActions.NEW.value),
            # ('FR', Business.LegalTypes.DOING_BUSINESS_AS.value, RequestActions.NEW.value),
            # ('FR', Business.LegalTypes.GENERAL_PARTNERSHIP.value, RequestActions.NEW.value),
            # ('CFR', Business.LegalTypes.SOLE_PROPRIETORSHIP.value, RequestActions.CHG.value),
            # ('CFR', Business.LegalTypes.GENERAL_PARTNERSHIP.value, RequestActions.CHG.value),
            # ('CFR', Business.LegalTypes.DOING_BUSINESS_AS.value, RequestActions.CHG.value),
            # ('LL', Business.LegalTypes.LIMITED_LIABILITY_PARTNERSHIP.value, RequestActions.NEW.value),
            # ('CLL', Business.LegalTypes.LIMITED_LIABILITY_PARTNERSHIP.value, RequestActions.CHG.value),
            # ('XLL', Business.LegalTypes.XPRO_LIMITED_LIABILITY_PARTNERSHIP.value, RequestActions.NEW.value),
            # ('XCLL', Business.LegalTypes.XPRO_LIMITED_LIABILITY_PARTNERSHIP.value, RequestActions.CHG.value),
            # ('LP', Business.LegalTypes.LIMITED_PARTNERSHIP.value, RequestActions.NEW.value),
            # ('CLP', Business.LegalTypes.LIMITED_PARTNERSHIP.value, RequestActions.CHG.value),
            # ('XLP', Business.LegalTypes.XPRO_LIMITED_PARTNERSHIP.value, RequestActions.NEW.value),
            # ('XCLP', Business.LegalTypes.XPRO_LIMITED_PARTNERSHIP.value, RequestActions.CHG.value),
            ...
            # ('XCP', Business.LegalTypes.XPRO_COOPERATIVE.value, RequestActions.NEW_AML.value),
            # ('XCP', Business.LegalTypes.XPRO_COOPERATIVE.value, RequestActions.NEW.value),
            # ('XCP', Business.LegalTypes.XPRO_COOPERATIVE.value, RequestActions.AML.value),
            # ('XCCP', Business.LegalTypes.XPRO_COOPERATIVE.value, RequestActions.CHG.value),
            # ('XRCP', Business.LegalTypes.XPRO_COOPERATIVE.value, RequestActions.REST.value),
            # ('XRCP', Business.LegalTypes.XPRO_COOPERATIVE.value, RequestActions.REH.value),
            # ('XRCP', Business.LegalTypes.XPRO_COOPERATIVE.value, RequestActions.REN.value),
            # ('CC', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.NEW_AML.value),
            # ('CC', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.NEW.value),
            # ('CC', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.AML.value),
            # ('CCV', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.CNV.value),
            # ('CCC', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.CHG.value),
            # ('CCCT', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.MVE.value),
            # ('RCC', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.REST.value),
            # ('RCC', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.REH.value),
            # ('RCC', Business.LegalTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestActions.REN.value),
            # ('UL', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.NEW.value),
            # ('UL', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.AML.value),
            # ('UC', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.CNV.value),
            # ('CUL', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.CHG.value),
            # ('ULCT', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.MVE.value),
            # ('RUL', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.REST.value),
            # ('RUL', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.REH.value),
            # ('RUL', Business.LegalTypes.UNLIMITED_LIABILITY_COMPANY.value, RequestActions.REN.value),
            ...
            # ('XUL', Business.LegalTypes.XPRO_UNLIMITED_LIABILITY_COMPANY.value, RequestActions.AML.value),
            # ('XCUL', Business.LegalTypes.XPRO_UNLIMITED_LIABILITY_COMPANY.value, RequestActions.CHG.value),
            # ('XRUL', Business.LegalTypes.XPRO_UNLIMITED_LIABILITY_COMPANY.value, RequestActions.REST.value),
            # ('XRUL', Business.LegalTypes.XPRO_UNLIMITED_LIABILITY_COMPANY.value, RequestActions.REH.value),
            # ('XRUL', Business.LegalTypes.XPRO_UNLIMITED_LIABILITY_COMPANY.value, RequestActions.REN.value),
        ...
        for item in sorted(request_type_mapping):
