...
class BusinessWarningCodes(str, Enum):
    ...
    TRANSITION_NOT_FILED_AFTER_12_MONTH_RESTORATION = "TRANSITION_NOT_FILED_AFTER_12_MONTH_RESTORATION"
...
def get_address_business_warning(
    address_referer: BusinessWarningReferers, address_type: str, business_warnings: BusinessWarnings
) -> dict:
    """Retrieve business warnings for an address."""
    warning_code = REFERER_WARNINGS_MAPPING[address_referer]["addresses"][address_type][business_warnings]
    return warning_code
