...
def check_address(address: Address,
    ...
    if referer not in (BusinessWarningReferers.BUSINESS_OFFICE, BusinessWarningReferers.BUSINESS_PARTY, BusinessWarningReferers.COMPLETING_PARTY) and not address.region:
        result.append(get_address_business_warning(referer,
                                                   address_type,
