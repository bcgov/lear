...
from legal_api.models import Filing, LegalEntity, EntityRole
...
def validate_amalgamating_businesses(  # pylint: disable=too-many-branches,too-many-statements,too-many-locals
    ...
    elif (legal_type in [LegalEntity.EntityTypes.BC_CCC.value, LegalEntity.EntityTypes.BC_ULC_COMPANY.value] and
