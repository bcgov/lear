...
def validate_effective_date(business: any, cod: Dict) -> List:
    ...
    last_cod_filing = Filing.get_most_recent_legal_filing(business, Filing.FILINGS["changeOfDirectors"]["name"])
    if last_cod_filing:
