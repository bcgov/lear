...
class PermissionService:
    ...
    def get_filing_permission_mapping(legal_type: str, filing_sub_type: str) -> dict:
        ...
        return {
            CoreFiling.FilingTypes.AGMEXTENSION.value: ListFilingsPermissionsAllowed.AGM_EXTENSION_FILING.value,
            CoreFiling.FilingTypes.AGMLOCATIONCHANGE.value: ListFilingsPermissionsAllowed.AGM_CHG_LOCATION_FILING.value,
            CoreFiling.FilingTypes.ALTERATION.value: ListFilingsPermissionsAllowed.ALTERATION_FILING.value,
            CoreFiling.FilingTypes.AMALGAMATIONAPPLICATION.value: ListFilingsPermissionsAllowed.AMALGAMATION_FILING.value,
            CoreFiling.FilingTypes.ANNUALREPORT.value: ListFilingsPermissionsAllowed.ANNUAL_REPORT_FILING.value,
            CoreFiling.FilingTypes.CHANGEOFADDRESS.value: ListFilingsPermissionsAllowed.ADDRESS_CHANGE_FILING.value,
            CoreFiling.FilingTypes.CHANGEOFREGISTRATION.value: ListFilingsPermissionsAllowed.FIRM_CHANGE_FILING.value,
            CoreFiling.FilingTypes.CHANGEOFDIRECTORS.value: ListFilingsPermissionsAllowed.DIRECTOR_CHANGE_FILING.value,
            CoreFiling.FilingTypes.CHANGEOFOFFICERS.value: ListFilingsPermissionsAllowed.OFFICER_CHANGE_FILING.value,
            CoreFiling.FilingTypes.CONSENTAMALGAMATIONOUT.value: ListFilingsPermissionsAllowed.CONSENT_AMALGAMATION_OUT_FILING.value,
            CoreFiling.FilingTypes.CONSENTCONTINUATIONOUT.value: ListFilingsPermissionsAllowed.CONSENT_CONTINUATION_OUT_FILING.value,
            CoreFiling.FilingTypes.CONTINUATIONIN.value: ListFilingsPermissionsAllowed.CONTINUATION_IN_FILING.value,
            CoreFiling.FilingTypes.CONVERSION.value: ListFilingsPermissionsAllowed.FIRM_CONVERSION_FILING.value,
            CoreFiling.FilingTypes.CORRECTION.value: ListFilingsPermissionsAllowed.CORRECTION_FILING.value,
            CoreFiling.FilingTypes.COURTORDER.value: ListFilingsPermissionsAllowed.COURT_ORDER_FILING.value,
            CoreFiling.FilingTypes.DISSOLUTION.value: get_dissolution_mapping(),
            CoreFiling.FilingTypes.INCORPORATIONAPPLICATION.value: ListFilingsPermissionsAllowed.INCORPORATION_APPLICATION_FILING.value,
            CoreFiling.FilingTypes.NOTICEOFWITHDRAWAL.value: ListFilingsPermissionsAllowed.NOTICE_WITHDRAWAL_FILING.value,
            CoreFiling.FilingTypes.RESTORATION.value: ListFilingsPermissionsAllowed.RESTORATION_REINSTATEMENT_FILING.value,
            CoreFiling.FilingTypes.REGISTRATION.value: ListFilingsPermissionsAllowed.REGISTRATION_FILING.value,
            CoreFiling.FilingTypes.SPECIALRESOLUTION.value: ListFilingsPermissionsAllowed.SPECIAL_RESOLUTION_FILING.value,
            CoreFiling.FilingTypes.TRANSITION.value: ListFilingsPermissionsAllowed.TRANSITION_FILING.value,
        }
        ...
        if required_permission not in authorized_permissions:
            return Error(
                ...
                [
                    {
                        "message": message
                        or f"Permission Denied - You do not have permissions to perform {required_permission} in filing."
                    }
                ],
            )
        return None
    ...
    def check_filing_enabled(filing_type: str, identifier: str) -> Error:
        ...
        filings_feature_flag = {"changeOfOfficers": "supported-change-of-officers-entities"}
