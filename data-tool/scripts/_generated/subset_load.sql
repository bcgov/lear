...
execute /home/kdeodhar/repos/lear/data-tool/scripts/_generated/subset_load_chunks/support/subset_pg_boolean_casts.sql
-- Fail-fast: verify varchar/bpchar -> boolean casts exist
select 't'::varchar::boolean;
select 'f'::bpchar::boolean;

execute /home/kdeodhar/repos/lear/data-tool/scripts/_generated/subset_load_chunks/support/subset_disable_triggers.sql

-- global cars* refresh (not corp-scoped; full dataset truncate + reload)
execute /home/kdeodhar/repos/lear/data-tool/scripts/_generated/subset_load_chunks/support/subset_delete_cars.sql
execute /home/kdeodhar/repos/lear/data-tool/scripts/_generated/subset_load_chunks/support/subset_transfer_cars.sql
...
execute /home/kdeodhar/repos/lear/data-tool/scripts/_generated/subset_load_chunks/support/subset_pg_purge_bcomps_excluded.sql

execute /home/kdeodhar/repos/lear/data-tool/scripts/_generated/subset_load_chunks/support/subset_enable_triggers.sql

-- Cleanup shared address staging table
execute /home/kdeodhar/repos/lear/data-tool/scripts/_generated/subset_load_chunks/support/subset_pg_cleanup_address_stage.sql
