-- Transfer a chunk (or a whole subset) of corps from the SOURCE Oracle DB (ctst) into the TARGET Postgres extract DB (ctst_pg).
--
...
-- corporation
transfer TARGET_SCHEMA.corporation from ctst using
with corp_list as (
...
-- event
transfer TARGET_SCHEMA.event from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- corp_name
transfer TARGET_SCHEMA.corp_name from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- corp_state
transfer TARGET_SCHEMA.corp_state from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- filing
transfer TARGET_SCHEMA.filing from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- filing_user
transfer TARGET_SCHEMA.filing_user from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
transfer TARGET_SCHEMA.subset_address_stage from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- office
transfer TARGET_SCHEMA.office from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- corp_comments
transfer TARGET_SCHEMA.corp_comments from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- ledger_text
transfer TARGET_SCHEMA.ledger_text from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- corp_party
transfer TARGET_SCHEMA.corp_party from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
transfer TARGET_SCHEMA.corp_party_relationship from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- offices_held
transfer TARGET_SCHEMA.offices_held from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- completing_party
transfer TARGET_SCHEMA.completing_party from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- submitting_party
transfer TARGET_SCHEMA.submitting_party from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- corp_flag
transfer TARGET_SCHEMA.corp_flag from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- cont_out
transfer TARGET_SCHEMA.cont_out from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- conv_event
transfer TARGET_SCHEMA.conv_event from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- conv_ledger
transfer TARGET_SCHEMA.conv_ledger from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
transfer TARGET_SCHEMA.corp_involved_amalgamating from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
transfer TARGET_SCHEMA.corp_involved_cont_in from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- corp_restriction
transfer TARGET_SCHEMA.corp_restriction from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- correction
transfer TARGET_SCHEMA.correction from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
transfer TARGET_SCHEMA.jurisdiction from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- resolution
transfer TARGET_SCHEMA.resolution from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- share_struct
transfer TARGET_SCHEMA.share_struct from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- share_struct_cls
transfer TARGET_SCHEMA.share_struct_cls from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- share_series
transfer TARGET_SCHEMA.share_series from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- notification
transfer TARGET_SCHEMA.notification from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- notification_resend
transfer TARGET_SCHEMA.notification_resend from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- party_notification
transfer TARGET_SCHEMA.party_notification from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
...
-- payment
transfer TARGET_SCHEMA.payment from ctst using
with corp_list as (
	select /*+ materialize */ c.corp_num
	from corporation c
	where &oracle_corp_num_predicate
