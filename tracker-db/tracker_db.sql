...
-- Started on 2021-06-21 08:39:12 PDT
...
CREATE DATABASE tracker_test OWNER "userA7C";
\c tracker_test
SET statement_timeout = 0;
SET lock_timeout = 0;
SET idle_in_transaction_session_timeout = 0;
...
--
-- TOC entry 196 (class 1259 OID 283254)
...
--
-- TOC entry 198 (class 1259 OID 283261)
...
--
-- TOC entry 197 (class 1259 OID 283259)
...
--
-- TOC entry 2745 (class 2604 OID 283264)
...
--
-- TOC entry 2875 (class 0 OID 283254)
-- Dependencies: 196
...
--
-- TOC entry 2877 (class 0 OID 283261)
-- Dependencies: 198
-- Data for Name: message_processing; Type: TABLE DATA; Schema: public; Owner: userA7C
--

COPY public.message_processing (id, message_id, identifier, message_type, status, message_json, create_date, last_update) FROM stdin;
\.
...
--
-- TOC entry 2747 (class 2606 OID 283258)
...
--
-- TOC entry 2753 (class 2606 OID 283269)
...
--
-- TOC entry 2748 (class 1259 OID 283270)
...
--
-- TOC entry 2749 (class 1259 OID 283271)
...
--
-- TOC entry 2750 (class 1259 OID 283272)
...
--
-- TOC entry 2751 (class 1259 OID 283273)
...
-- Completed on 2021-06-21 08:39:15 PDT
