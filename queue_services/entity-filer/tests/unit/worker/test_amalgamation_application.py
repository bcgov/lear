...
from tests.unit import create_entity, create_filing, create_share_class
...
def test_regular_amalgamation_application_process(app, session):
    ...
    for amalgamating_business in amalgamation.amalgamating_businesses:
        ...
        if amalgamating_business.business_id:
            ...
            dissolved_business = LegalEntity.find_by_internal_id(amalgamating_business.business_id)
...
async def test_short_form_amalgamation_application_process(app, session, amalgamation_type, amalgamating_role):
    ...
    # TODO: implement create_party() & create_entity_role()
    # party = create_party(
    #     {
    #         "officer": {
