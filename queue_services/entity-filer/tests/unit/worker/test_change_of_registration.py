...
def test_change_of_registration_legal_name(app, session, mocker, test_name, legal_name, new_legal_name,
...
def test_change_of_registration_business_address(app, session, mocker, test_name, legal_type, legal_name,
                                                       filing_template):
