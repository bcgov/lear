...
import pytest
from legal_api.models import ConsentContinuationOut, Filing
...
async def test_worker_consent_amalgamation_out(app, session, mocker, test_name, effective_date, expiry_date):
