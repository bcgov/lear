...
def test_new_aliases(app, session):
    ...
    component = {
        "nameTranslations": [
            {"name": "MÉDIAS DE TRANSPORT INC."},
            {"name": "CLUDIANT MEDIA INC."},
        ]
    }
...
def test_modified_aliases(app, session):
    ...
    component = {
        "nameTranslations": [
            {"id": str(business_aliases[0].id), "name": new_value_1},
            {"id": str(business_aliases[1].id), "name": new_value_2},
        ]
    }
...
def test_cease_aliases(app, session):
    ...
    component = {"nameTranslations": [{"name": alias_3}]}
...
def test_all_aliases(app, session):
    ...
    component = {
        "nameTranslations": [
            {"id": str(business_aliases[0].id), "name": alias_3},
            {"name": alias_4},
        ]
    }
