...
def test_publish_event(app, session):
    """Assert that filing event is placed on the queue."""
    # Call back for the subscription
    from entity_filer.worker import APP_CONFIG, publish_event, gcp_queue
...
# ##############################################################################
# ################# Legacy Code for Reference while migrating ##################
# ##############################################################################
# TODO: Remove this when migration is completed
#
