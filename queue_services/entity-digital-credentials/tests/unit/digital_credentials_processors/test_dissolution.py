...
from entity_digital_credentials.digital_credentials_processors.dissolution import process
...
@patch('entity_digital_credentials.digital_credentials_processors.dissolution.replace_digital_credential')
