...
def tests_filer_notice_of_withdrawal(session, test_name, filing_type, filing_template, identifier):
    ...
    if identifier.startswith('T'):
        business= RegistrationBootstrap(account=28)
        business.identifier = f'T{random.randint(1000000,9999999)}'
        business.save()
