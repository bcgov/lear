...
@patch.object(dissolution, 'replace_digital_credential')
@patch.object(dissolution, 'revoke_digital_credential')
def test_processor_does_not_run_if_invalid_sub_type(mock_revoke_digital_credential,
                                                          mock_replace_digital_credential,
                                                          mock_get_all_digital_credentials_for_business,
                                                          app, session):
...
@patch.object(dissolution, 'replace_digital_credential')
@patch.object(dissolution, 'revoke_digital_credential')
def test_processor_replaces_issued_credential(mock_revoke_digital_credential,
                                                    mock_replace_digital_credential,
                                                    mock_get_all_digital_credentials_for_business,
                                                    app, session):
    ...
    # Act
    dissolution.process(business, 'voluntary')
...
def test_processor_revokes_issued_credential(mock_revoke_digital_credential,
    ...
    # Act
    dissolution.process(business, 'administrative')
