...
import pytest
from business_model.models import DCDefinition, DCRevocationReason, Filing
...
@patch.object(change_of_registration, 'replace_digital_credential')
def test_processor_does_not_run_if_invalid_typel(mock_replace_digital_credential,
                                                 mock_get_all_digital_credentials_for_business,
                                                       app, session):
