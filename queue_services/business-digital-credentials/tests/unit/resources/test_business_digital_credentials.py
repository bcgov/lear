...
def test_worker_success(mock_get_cloud_event, mock_process_event, test_client):
...
@patch('business_digital_credentials.resources.business_digital_credentials.process_event')
@patch('business_digital_credentials.services.gcp_queue.get_simple_cloud_event')
def test_worker_no_event(mock_get_cloud_event, mock_process_event, test_client):
...
@patch('business_digital_credentials.resources.business_digital_credentials.process_event')
@patch('business_digital_credentials.services.gcp_queue.get_simple_cloud_event')
def test_worker_queue_exception(mock_get_cloud_event, mock_process_event, test_client):
