...
def test_continuation_out_notification(status, legal_type, submitter_role):
    """Assert that the continuation_out email processor for corps works as expected."""
    # setup filing + business for email
    legal_name = 'test business'
    filing = prep_continuation_out_filing('BC1234567', '1', legal_type, legal_name, submitter_role)
    token = 'token'
    # test processor
