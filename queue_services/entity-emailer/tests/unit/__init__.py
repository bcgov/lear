...
def prep_incorp_filing(session, identifier, payment_id, option, legal_type='BC'):
    ...
    filing_template['filing']['business'] = {'identifier': business.identifier, 'legalType': business.legal_type}
