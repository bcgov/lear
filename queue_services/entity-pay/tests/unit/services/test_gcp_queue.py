...
from entity_pay.services.gcp_queue import GcpQueue
...
@pytest.mark.parametrize('test_name,msg,expected', [
    ('invalid', {}, False),
    ('valid', BASE_ENVELOPE, True)
])
...
@pytest.mark.parametrize('test_name,queue_envelope,expected, ret_type', [
    ('invalid', {}, None, type(None)),
    ('valid', BASE_ENVELOPE, BASE_ENVELOPE, dict)
])
