...
"""Email processing rules and actions for AGM Location Change notifications."""
...
def process(email_info: dict, token: str) -> dict:  # pylint: disable=too-many-locals, too-many-branches
    ...
    current_app.logger.debug("agm_location_change_notification: %s", email_info)
    ...
    template = Path(
        f'{current_app.config.get("TEMPLATE_PATH")}/AGM-LOCCHG-{status}.html'
    ).read_text()
